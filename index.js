...
// Both let and const help control the mutabilty and scope of the state. var has tradionally been the only way to pass variable data and with ES6 there is new options to pass the variable data along.
// Closures
...
// let hijacks the block and returns "i" each pass thru. It does not run the full loop each time and return the same number. This Syntax is a lot cleaner and returns i for each loop thru. Var runs thru all iterations of the loop before returning the data.
for (let i=1; i<=6; i++) {
	setTimeout( function timer(){
		console.log( i );
	}, i*1000 );
...
function closureFunc() {
  let name = 'Zoidberg';// declaring the const data in the inital block
